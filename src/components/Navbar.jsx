    ...
    <nav className="fixed top-0 left-0 w-full glass z-50 border-b border-[#49454F]/30 py-4 px-6 md:px-12 flex justify-between items-center transition-all duration-300">
      ...
      {mobileMenuOpen && (
        <div className="absolute top-20 left-0 w-full bg-[#1A1A1E] border-b border-white/5 flex flex-col items-center py-6 gap-6 shadow-2xl md:hidden">
          ...
          <button className="mt-4 bg-[#D0BCFF] text-[#381E72] px-8 py-3 rounded-full font-bold hover:bg-[#EADDFF] transition-all shadow-[0_0_15px_rgba(208,188,255,0.3)] cursor-pointer">
            Add to Browser
          </button>
        </div>
      )}
